      ...
      <div className="space-y-6 py-4">
          ...
          <div className="flex flex-wrap items-center gap-3">
            {detail.status === 'PLANNED' && (
              <button
                ...
                className="inline-flex items-center gap-2 rounded-xl bg-emerald-600 px-4 py-2.5 text-xs font-bold text-white shadow-glow hover:bg-emerald-700 transition-colors disabled:opacity-60"
              >
            ...
            {detail.status === 'ACTIVE' && (
              <button
                ...
                disabled={action.isPending}
                className="inline-flex items-center gap-2 rounded-xl bg-sky-600 px-4 py-2.5 text-xs font-bold text-white shadow-glow hover:bg-sky-700 transition-colors disabled:opacity-60"
              >
            ...
            <button
              ...
              disabled={action.isPending}
              className="inline-flex items-center gap-2 rounded-xl border border-rose-500/40 text-rose-500 px-4 py-2.5 text-xs font-bold hover:bg-rose-500/10 transition-colors disabled:opacity-60"
            >
              <X className="h-4 w-4" />
              Cancel Journey
            </button>
        ...
        {isActive ? (
          ...
          <div className="glass-panel rounded-3xl p-6 border border-slate-200 dark:border-slate-800">
            ...
            {detail.status === 'PLANNED' && (
              <Link
                href={`/train/${detail.trainNumber}`}
                className="mt-4 inline-flex items-center gap-2 rounded-xl bg-rail-blue px-4 py-2 text-xs font-bold text-white shadow-glow hover:bg-sky-600 transition-colors"
              >
